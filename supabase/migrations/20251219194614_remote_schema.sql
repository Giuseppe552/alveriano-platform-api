...
CREATE TABLE IF NOT EXISTS "public"."payments" (
    ...
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "site" "text" NOT NULL,
    "form_submission_id" "uuid" DEFAULT "gen_random_uuid"(),
...
ALTER TABLE ONLY "public"."payments"
    ADD CONSTRAINT "payments_form_submission_id_fkey" FOREIGN KEY ("form_submission_id") REFERENCES "public"."form_submissions"("id") ON DELETE SET NULL;
